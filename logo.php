        ...
        ?>
                    ...
                    <div class="container-fluid">
                       ...
                       <form class="form-horizontal" name="logo" method="post" action="detail_save.php" enctype="multipart/form-data"> 
                          ...
                          <div class="col-md-9"> <input type="text" name="title" class="form-contol" size="125px" required></div>
                           </div><br>
                               
                               <div class="row">
                                  <div class="col-md-3"> 
                          <center> <label class="control-label">Meta tag (Keyword) :</label></center></div> 
                          <div class="col-md-9"> <input type="text" name="keyword" class="form-contol" size="125px" required></div>
                           </div><br>
                               
                               <div class="row">
                                  <div class="col-md-3"> 
                          <center> <label class="control-label">Meta tag (Descriprion) :</label></center></div> 
                          <div class="col-md-9"> <input type="text" name="desc" class="form-contol" size="125px" required></div>
                           </div><br>
                               
                               <div class="row">
                                  <div class="col-md-3"> 
                          <center> <label class="control-label">Website logo :</label></center></div> 
                          <div class="col-md-9"> <input type="file" name="fileLogo" class="form-contol" style=" padding:2px; border:solid #8080804d 2px; width: 1026px; " required></div>
                           </div><br>                           
                           <br>
                           <hr>
