                    ...
                    <div class="card o-hidden border-0 shadow-lg my-5">
                        <div class="card-header">
                            <div class="text-center">
                                <h1 class="h4 text-dark p-3">PhD Viva</h1>
                            </div>
                        </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body" id="std_info_card">
                                <div class="container-fluid">
                                    ...
                                    <div class="row shadow-lg pb-4">
                                        <h5 class="bg-primary col-md-12 mb-3 pl-2 pt-2 pb-1 text-white">Actions</h5>
                                        <div class="col-md-3"></div>
                                        <div class="col-md-6">
                                            <label class="font-weight-bold mt-2">SELECT AN EXAMINER</label>
                                            <select class="form-control">
                                                <option hidden selected disabled="disabled">SELECT</option>
                                        ...
                                        <div class="col-md-6 p-0 d-flex justify-content-between">
                                            <div class="col-md-6">
                                                <label class="font-weight-bold mt-2">SCHEDULE DATE</label>
                                                <input type="date" class="form-control">
                                            </div>
                                            <div class="col-md-6">
                                                <label class="font-weight-bold mt-2">SCHEDULE TIME</label>
                                        ...
                                        <div class="col-md-3"></div>
                                        <div class="col-md-6">
                                            <label class="font-weight-bold mt-2">UPLOAD SUPPORTING DOCS</label>
