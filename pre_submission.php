                                                            ...
                                                            <div class="modal-dialog modal-xl" role="document">
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="ModalLongTitle">Pre PHD Submission</h5>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="container-fluid">
                                                                            ...
                                                                            <div class="row shadow-lg mb-4">
                                                                                 <h5 class="bg-primary col-md-12 mb-3  pt-2 pb-1 text-white">Contact Details</h5>
                                                                                <div class="col-md-10 row">
                                                                                    ...
                                                                                    <div class="col-md-4 row">
                                                                                        <p class="col-4">Dept. Name:</p>
                                                                                        <p class="col-md-8">Department of Science</p>
                                                                                    </div>
                                                                                     <div class="col-md-4 row">
                                                                                    ...
                                                                                    <div class="col-md-6 row">
                                                                                        <p class="col-6">Synopsis Title:</p>
                                                                                        <p class="col-md-6">Sample Title</p>
                                                                                    </div>
                                                                            ...
                                                                            <div class="row shadow-lg mb-4" style="padding-bottom:30px;">
                                                                                 <h5 class="bg-primary col-md-12 mb-3  pt-2 pb-1 text-white">Pre Submission Details</h5>
