                    ...
                    <div class="card o-hidden border-0 shadow-lg my-5">
                        <div class="card-header">
                            <div class="text-center">
                                <h1 class="h4 text-dark p-3">Course Work Result</h1>
                            </div>
                        </div>
                        <div class="card-body p-0">
                            <div class="container-fluid p-3">
                                ...
                                <div class="container-fluid text-center">
                                    <button class="btn btn-primary btn-lg" id="srch_cwr">Submit</button>
                                </div>
                                </form>
                                ...
                                <table class="table table-striped mt-3">
                                    ...
                                    <tbody id="cwr_data_table">
                                    </tbody>
                                </table>

                                <div class="container-fluid text-center">
                                    <button class="btn btn-primary text-center">Submit Marks</button>
                                </div>
                            </div>
                        </div>
                    </div>
