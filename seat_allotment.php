...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Content Wrapper -->
        <div id="content-wrapper" class="d-flex flex-column justify-content-md-start">
                    ...
                    <div class="card border-0 shadow-lg">
                        <div class="card-header">
                            <div class="text-center">
                                <h1 class="h4 text-dark p-3">Seat Allotment</h1>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="container-fluid">
                                ...
                                <div class="container-fluid text-center">
                                    <button class="btn btn-primary btn-lg" id="srch_student">Search</button>
                                </div>
                                </form>
